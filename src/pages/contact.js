...
const ContactPage = () => {
    return (
        ...
        <a href="https://www.instagram.com/domsantiagobarajas/" target="_blank">
        <fieldset className={fieldsetSocial}>
            <StaticImage className={socialLink} alt="instagram" src="../images/instagram_logo.png" />
        </fieldset>
        </a>
        <br></br>
        ...
        <fieldset className={fieldsetSocial}>
            ...
            <StaticImage className={socialLink} alt="twitter" src="../images/twitter_logo.png" />
        </fieldset>
        </a>
